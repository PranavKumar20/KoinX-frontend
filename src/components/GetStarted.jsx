  ...
  return (
    <div className="bg-blue-700 h-96 mx-2 my-2 rounded-lg shadow-sm text-white">
      <div className="flex w-52 mx-auto">
        <p className="text-lg mt-2 mx-auto font-medium text-center font-medium">
      ...
      <img
        className="h-28 m-auto rounded-lg"
      ...
      />
      <div className="flex">
        <button className="mx-auto my-2 border-2 flex p-2 text-black bg-white rounded-lg font-medium hover:bg-gray-200 ">
